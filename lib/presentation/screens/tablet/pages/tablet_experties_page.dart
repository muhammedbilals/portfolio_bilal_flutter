...
class TabletExpertiesPage extends StatefulWidget {
  const TabletExpertiesPage({
    super.key,
  });

  @override
  State<TabletExpertiesPage> createState() => _TabletExpertiesPageState();
}

class _TabletExpertiesPageState extends State<TabletExpertiesPage>
